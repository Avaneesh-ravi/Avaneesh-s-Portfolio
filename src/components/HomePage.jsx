        ...
        <div className="flex flex-col lg:flex-row items-center justify-between w-full gap-12 px-4 py-10">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-400 max-w-xl mx-auto lg:mx-0">
              Creative and detail-oriented developer skilled in Python, C, and Web Development.
              Passionate about designing intuitive UI/UX experiences using Figma and building
              real-world applications like Donation Tracking Systems and AI-powered tools.
            </p>
            ...
            <div className="relative group w-fit mx-auto lg:mx-0">
              ...
              <div className="absolute left-1/2 lg:left-0 transform -translate-x-1/2 lg:translate-x-0 mt-4 px-5 py-3 backdrop-blur-md bg-white/10 border border-white/20 text-white text-sm rounded-xl shadow-[0_4px_30px_rgba(255,255,255,0.1)] opacity-0 group-hover:opacity-100 transition-all duration-300 ease-in-out pointer-events-none z-20 space-y-1 w-64 text-center">
                <p className="font-semibold tracking-wide">📧 avaneeshravi4084@gmail.com</p>
                <p className="font-semibold tracking-wide">📞 +91-9842951881</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <p className="text-base sm:text-lg md:text-xl text-gray-400">
              Software Developer | UI/UX Designer | SIH 2025 Finalist
            </p>
            <p className="text-sm sm:text-base text-gray-300">
              Currently pursuing Computer Science and Design at Kongu Engineering College.
              Focused on building scalable web applications, AI tools, and user-centric digital solutions.
            </p>
          </motion.div>
        </div>
