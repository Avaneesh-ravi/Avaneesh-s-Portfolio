...
const certificates = [
...

  {
    ...
    description:
      'Oracle Certified Professional recognition for APEX Cloud Developer skills.',
    image: '/oracle.png',
    link: '/oracle.png',
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center mb-24">
        <motion.h1
          style={{ y: yParallax }}
          className="absolute text-[120px] md:text-[160px] font-extrabold bg-gradient-to-r from-green-400 to-teal-300 bg-clip-text text-transparent opacity-10 -top-10 left-1/2 -translate-x-1/2 select-none pointer-events-none whitespace-nowrap"
        >
          CERTIFICATES
        </motion.h1>
          ...
          >
            ...
            <div className="p-6 text-center">
              ...
              <p className="text-green-300 text-sm mb-2">
                Issued by <span className="font-medium">{issuer}</span>
              </p>
