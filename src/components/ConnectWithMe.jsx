...
const ConnectWithMe = () => {
  ...
  const sendEmail = (e) => {
    ...
    // Verified Credentials from your latest screenshots:
    // Service ID: service_09yye0a
    // Public Key: l8jHuMga9aa1ZK7sv
    const SERVICE_ID = 'service_09yye0a';
    ...
    emailjs
      ...
      .then(
        ...
        (error) => {
          ...
          // If you see this, you likely still need to fix the Gmail "Send" permission
          alert('❌ Connection successful, but Gmail blocked the send. Re-link Gmail with "Send" permissions.');
          setLoading(false);
        }
      );
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="mt-4 text-gray-400 text-sm">📧 avaneeshravi4084@gmail.com | 📞 +91-9842951881</p>
      </motion.div>
