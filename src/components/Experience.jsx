...
const experience = {
  ...
  company: "Hybrid Renewable Energy Project",
  period: "2025",
  description:
    "Selected as a finalist in Smart India Hackathon 2025. Worked on a hybrid renewable energy generation solution focusing on sustainability, research, and innovative problem-solving.",
};
  ...
  <section className="min-h-screen flex flex-col items-center justify-center px-4 py-20 bg-black">
    ...
    <div className="relative flex flex-col items-center w-full max-w-xl">
      ...
      >
        ...
        <div className="text-green-300 text-lg mb-0.5">
          {experience.company}
        </div>
